                 ...
                 HGroup(
                  HGroup(
                     ...
                     VGroup(Item(name='calib_label', show_label=False, style='readonly'),
                            Item(name='calib_opts', editor=EnumEditor(values=calib_options),
                                 enabled_when='calib_opts_enabled', label='CalibOpt', show_label=False),
                            visible_when='calib_opts_visible==True'),
                     VGroup(Item(name='session_label', show_label=False, style='readonly'),
                            Item(name='calib_session', width=175, editor=EnumEditor(name='calib_session_list'),
                                 enabled_when='calib_session_enabled', show_label=False),
                            visible_when='calib_session_visible==True'), springy=True),
                     HGroup(
                       Item(name='start', editor=ButtonEditor(label_value='start_button_label'), show_label=False, enabled_when='start_enabled', height=48),
                       Item(name='stop', show_label=False, enabled_when='stop_enabled', visible_when='stop_visible==True', height=48),
                       Item(name='kill', show_label=False, enabled_when='kill_enabled', height=48),
                       Item(name='config', show_label=False, enabled_when='config_enabled', height=48),
                       visible_when='True')),
                    HGroup(
